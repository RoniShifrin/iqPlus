...
_T: dict = {
    "en": {
        ...
        # ── Weekly Summary ────────────────────────────────────────────
        "ws.no_data":                   "Not enough recent data to generate a full summary. This summary is based on available data only.",
        "ws.student.attendance_good":   "Your attendance was strong this week.",
        "ws.student.attendance_poor":   "Your attendance was below expectations this week — try to attend the upcoming lessons.",
        "ws.student.grades_high":       "Your assignment performance was above average.",
        "ws.student.grades_low":        "Your assignment completion was lower than usual — focus on catching up.",
        "ws.student.trend_improving":   "Your progress trend is improving — keep up the momentum.",
        "ws.student.trend_declining":   "Your progress trend is declining — consider reviewing the material.",
        "ws.student.feedback_positive": "You received positive feedback from your teacher this week.",
        "ws.student.feedback_concern":  "Your teacher noted some areas of concern — check the feedback section.",
        "ws.student.alerts":            "You have {n} active alert(s) to review in your dashboard.",
        "ws.student.no_alerts":         "No urgent alerts this week — keep up the good work!",

        "ws.parent.attendance_ok":      "{child} attended {present} of {total} lesson(s) this week.",
        "ws.parent.trend_declining":    "{child}'s progress trend is declining — a supportive conversation may help.",
        "ws.parent.trend_improving":    "{child}'s progress trend is improving — great momentum this week.",
        "ws.parent.feedback_positive":  "{child} received positive feedback from their teacher.",
        "ws.parent.feedback_concern":   "{child}'s teacher noted some areas of concern — check the feedback section.",
        "ws.parent.alert_active":       "Active alert for {child}: {message}",
        "ws.parent.all_good":           "Everything looks stable for {child} this week. No urgent issues detected.",

        "ws.teacher.class_avg":         "{course}: class average this week is {avg}/100.",
        "ws.teacher.risk_students":     "{course}: {n} student(s) at high risk need your attention.",
        "ws.teacher.improving_students":"{course}: {n} student(s) show an improving trend.",
        "ws.teacher.no_courses":        "No active courses found. Create and publish a course to start tracking student progress.",
        "ws.teacher.all_ok":            "All courses appear to be progressing normally this week.",

        "ws.admin.active_courses":      "{n} active course(s) are running this week.",
        "ws.admin.risk_students":       "{n} student(s) are flagged at high academic risk across the platform.",
        "ws.admin.recent_alerts":       "{n} AI alert(s) were generated in the past 7 days.",
        "ws.admin.declining_courses":   "{n} course(s) show declining performance trends.",
        "ws.admin.stable":              "No urgent academic issues detected this week. The platform looks stable.",

        # ── Score Explanation ─────────────────────────────────────────
        "se.no_data":                   "No score data available yet. A score will be calculated as academic data is recorded.",
        "se.limited_data":              "This explanation is based on available data only — some components may be incomplete.",
        "se.intro_excellent":           "Your score of {score}/100 reflects strong overall academic performance.",
        "se.intro_good":                "Your score of {score}/100 shows solid and consistent progress.",
        "se.intro_average":             "Your score of {score}/100 is at an average level with clear room for improvement.",
        "se.intro_needs_attention":     "Your score of {score}/100 indicates this course needs more focused attention.",
        "se.grades_positive":           "Strong grades (grade component: {grade_score}/100) are a major positive contributor.",
        "se.grades_negative":           "Lower grades (grade component: {grade_score}/100) are the main factor reducing your score.",
        "se.attendance_positive":       "Consistent attendance (attendance component: {att_score}/100) is positively boosting your score.",
        "se.attendance_negative":       "Attendance (component: {att_score}/100) is below expectations and is negatively affecting your score.",
        "se.feedback_positive":         "Positive teacher feedback (feedback component: {fb_score}/100) is contributing positively to your score.",
        "se.feedback_negative":         "Teacher feedback (component: {fb_score}/100) reflects concerns and is reducing your score.",
        "se.trend_positive":            "Your improving progress trend is a positive sign and contributes to a higher score.",
        "se.trend_negative":            "A declining progress trend is currently pulling your score lower.",
        "se.overall_strong":            "Overall, your score is mainly supported by your {top_factor}.",
        "se.overall_weak":              "To improve your score, focus on: {bottom_factor}.",

        # ── Action Items ──────────────────────────────────────────────
        "it.student.check_feedback":        "Review your latest teacher feedback to understand where to improve.",
        "it.student.improve_attendance":    "Your attendance dropped recently — aim to attend the next scheduled lessons.",
        "it.student.focus_weak_course":     "Give extra attention to {course}, where your performance needs improvement.",
        "it.student.high_workload":         "Your course load is high — avoid adding new courses until your scores stabilize.",
        "it.student.complete_assignments":  "Complete any missing or overdue assignments before they impact your overall score.",
        "it.student.keep_up":               "You're on track — keep your current study habits and attendance consistent.",

        "it.parent.check_attendance":       "Check your child's attendance record — some recent lessons were missed.",
        "it.parent.contact_teacher":        "Consider contacting the teacher — {child} has an active high-risk alert.",
        "it.parent.discuss_course":         "Discuss {course} with your child — their performance there needs attention.",
        "it.parent.monitor_workload":       "Monitor your child's course workload — they are enrolled in multiple courses.",
        "it.parent.review_feedback":        "Review the latest teacher feedback with your child.",
        "it.parent.all_ok":                 "No urgent actions needed this week. Your child appears to be progressing well.",

        "it.teacher.review_declining":      "Review students showing declining trends: {names}.",
        "it.teacher.provide_feedback":      "{n} student(s) have not received recent feedback — consider adding feedback.",
        "it.teacher.check_attendance":      "Check low-attendance students this week: {names}.",
        "it.teacher.course_attention":      "{course}: {n} student(s) need attention — consider a group review session.",
        "it.teacher.all_ok":                "All students are progressing normally. No urgent teacher actions needed.",

        "it.admin.review_risk":             "Review {n} high-risk student(s) flagged across the platform.",
        "it.admin.check_courses":           "{n} course(s) show declining performance trends — follow up with the relevant teachers.",
        "it.admin.teacher_load":            "{n} teacher(s) are managing a high course load — consider offering support.",
        "it.admin.recent_alerts":           "Review {n} recent AI alert(s) generated in the past 7 days.",
        "it.admin.all_stable":              "No urgent actions required this week. The platform looks stable.",
    },
    ...
    "he": {
        ...
        # ── Weekly Summary ────────────────────────────────────────────
        "ws.no_data":                   "אין מספיק נתונים עדכניים לסיכום מלא. הסיכום מבוסס על נתונים זמינים בלבד.",
        "ws.student.attendance_good":   "הנוכחות שלך הייתה טובה השבוע.",
        "ws.student.attendance_poor":   "הנוכחות שלך הייתה נמוכה מהצפוי השבוע — נסה להגיע לשיעורים הקרובים.",
        "ws.student.grades_high":       "ביצועי המטלות שלך היו מעל הממוצע.",
        "ws.student.grades_low":        "השלמת המטלות שלך הייתה נמוכה מהרגיל — כדאי להשלים את הפערים.",
        "ws.student.trend_improving":   "מגמת ההתקדמות שלך משתפרת — המשך כך!",
        "ws.student.trend_declining":   "מגמת ההתקדמות שלך יורדת — כדאי לחזור על החומר.",
        "ws.student.feedback_positive": "קיבלת משוב חיובי מהמורה השבוע.",
        "ws.student.feedback_concern":  "המורה ציין כמה נושאים לשיפור — בדוק את סעיף המשוב.",
        "ws.student.alerts":            "יש לך {n} התראה(ות) פעילה(ות) לבדיקה בלוח הבקרה שלך.",
        "ws.student.no_alerts":         "אין התראות דחופות השבוע — עבודה טובה!",

        "ws.parent.attendance_ok":      "{child} השתתף ב-{present} מתוך {total} שיעור(ים) השבוע.",
        "ws.parent.trend_declining":    "מגמת ההתקדמות של {child} יורדת — שיחת תמיכה עשויה לעזור.",
        "ws.parent.trend_improving":    "מגמת ההתקדמות של {child} משתפרת — תנופה נהדרת השבוע.",
        "ws.parent.feedback_positive":  "{child} קיבל משוב חיובי מהמורה.",
        "ws.parent.feedback_concern":   "המורה של {child} ציין כמה נושאים לשיפור — בדוק את סעיף המשוב.",
        "ws.parent.alert_active":       "התראה פעילה עבור {child}: {message}",
        "ws.parent.all_good":           "הכול נראה יציב עבור {child} השבוע. לא זוהו בעיות דחופות.",

        "ws.teacher.class_avg":         "{course}: ממוצע הכיתה השבוע הוא {avg}/100.",
        "ws.teacher.risk_students":     "{course}: {n} תלמיד(ים) בסיכון גבוה זקוקים לתשומת לב.",
        "ws.teacher.improving_students":"{course}: {n} תלמיד(ים) מראים מגמת שיפור.",
        "ws.teacher.no_courses":        "לא נמצאו קורסים פעילים. צור ופרסם קורס כדי להתחיל לעקוב אחר התקדמות התלמידים.",
        "ws.teacher.all_ok":            "כל הקורסים נראים מתקדמים באופן תקין השבוע.",

        "ws.admin.active_courses":      "{n} קורס(ים) פעיל(ים) מתקיים(ים) השבוע.",
        "ws.admin.risk_students":       "{n} תלמיד(ים) מסומנים בסיכון אקדמי גבוה בפלטפורמה.",
        "ws.admin.recent_alerts":       "{n} התראה(ות) בינה מלאכותית נוצרו ב-7 הימים האחרונים.",
        "ws.admin.declining_courses":   "{n} קורס(ים) מראים מגמות ביצוע יורדות.",
        "ws.admin.stable":              "לא זוהו בעיות אקדמיות דחופות השבוע. הפלטפורמה נראית יציבה.",

        # ── Score Explanation ─────────────────────────────────────────
        "se.no_data":                   "עדיין אין נתוני ציון זמינים. ציון יחושב כאשר יוקלטו נתונים אקדמיים.",
        "se.limited_data":              "ההסבר מבוסס על נתונים זמינים בלבד — ייתכן שחלק מהרכיבים אינם מלאים.",
        "se.intro_excellent":           "הציון שלך {score}/100 משקף ביצועים אקדמיים כוללים חזקים.",
        "se.intro_good":                "הציון שלך {score}/100 מצביע על התקדמות מוצקה ועקבית.",
        "se.intro_average":             "הציון שלך {score}/100 הוא ברמה ממוצעת עם מקום ברור לשיפור.",
        "se.intro_needs_attention":     "הציון שלך {score}/100 מצביע שהקורס הזה זקוק לתשומת לב ממוקדת יותר.",
        "se.grades_positive":           "ציונים חזקים (רכיב ציונים: {grade_score}/100) הם גורם חיובי מרכזי.",
        "se.grades_negative":           "ציונים נמוכים (רכיב ציונים: {grade_score}/100) הם הגורם העיקרי להורדת הציון.",
        "se.attendance_positive":       "נוכחות עקבית (רכיב נוכחות: {att_score}/100) משפיעה לטובה על הציון שלך.",
        "se.attendance_negative":       "הנוכחות (רכיב: {att_score}/100) נמוכה מהצפוי ומשפיעה לרעה על הציון שלך.",
        "se.feedback_positive":         "משוב חיובי מהמורה (רכיב משוב: {fb_score}/100) תורם לציון גבוה יותר.",
        "se.feedback_negative":         "משוב המורה (רכיב: {fb_score}/100) משקף חששות ומוריד מהציון שלך.",
        "se.trend_positive":            "מגמת ההתקדמות המשתפרת שלך היא סימן חיובי ותורמת לציון גבוה יותר.",
        "se.trend_negative":            "מגמת ירידה בביצועים מורידה את הציון שלך כרגע.",
        "se.overall_strong":            "בסך הכול, הציון שלך נתמך בעיקר על ידי {top_factor}.",
        "se.overall_weak":              "כדי לשפר את הציון שלך, התמקד ב: {bottom_factor}.",

        # ── Action Items ──────────────────────────────────────────────
        "it.student.check_feedback":        "עיין במשוב האחרון של המורה כדי להבין היכן כדאי להשתפר.",
        "it.student.improve_attendance":    "הנוכחות שלך ירדה לאחרונה — נסה להגיע לשיעורים הקרובים בלוח הזמנים.",
        "it.student.focus_weak_course":     "הקדש תשומת לב נוספת ל-{course}, שם הביצועים שלך זקוקים לשיפור.",
        "it.student.high_workload":         "עומס הקורסים שלך גבוה — הימנע מהוספת קורסים חדשים עד שהציונים שלך יתייצבו.",
        "it.student.complete_assignments":  "השלם מטלות חסרות או פגות לפני שישפיעו על הציון הכולל שלך.",
        "it.student.keep_up":               "אתה על המסלול — שמור על הרגלי הלמידה והנוכחות הנוכחיים שלך.",

        "it.parent.check_attendance":       "בדוק את רשומת הנוכחות של ילדך — חלק מהשיעורים האחרונים הוחמצו.",
        "it.parent.contact_teacher":        "שקול ליצור קשר עם המורה — ל-{child} יש התראת סיכון גבוה פעילה.",
        "it.parent.discuss_course":         "שוחח עם ילדך על {course} — הביצועים שם זקוקים לתשומת לב.",
        "it.parent.monitor_workload":       "עקוב אחר עומס הקורסים של ילדך — הם רשומים למספר קורסים.",
        "it.parent.review_feedback":        "עיין במשוב האחרון של המורה יחד עם ילדך.",
        "it.parent.all_ok":                 "אין פעולות דחופות הדרושות השבוע. ילדך נראה מתקדם היטב.",

        "it.teacher.review_declining":      "בדוק תלמידים המראים מגמות ירידה: {names}.",
        "it.teacher.provide_feedback":      "{n} תלמיד(ים) לא קיבלו משוב לאחרונה — שקול להוסיף משוב.",
        "it.teacher.check_attendance":      "בדוק תלמידים עם נוכחות נמוכה השבוע: {names}.",
        "it.teacher.course_attention":      "{course}: {n} תלמיד(ים) זקוקים לתשומת לב — שקול לקיים שיעור חזרה קבוצתי.",
        "it.teacher.all_ok":                "כל התלמידים מתקדמים באופן תקין. אין פעולות מורה דחופות.",

        "it.admin.review_risk":             "בדוק {n} תלמיד(ים) בסיכון גבוה המסומנים בפלטפורמה.",
        "it.admin.check_courses":           "{n} קורס(ים) מראים מגמות ביצוע יורדות — עקוב אחר המורים הרלוונטיים.",
        "it.admin.teacher_load":            "{n} מורה(ים) מנהלים עומס קורסים גבוה — שקול להציע תמיכה.",
        "it.admin.recent_alerts":           "בדוק {n} התראות בינה מלאכותית שנוצרו ב-7 הימים האחרונים.",
        "it.admin.all_stable":              "אין פעולות דחופות הדרושות השבוע. הפלטפורמה נראית יציבה.",
    },
}
